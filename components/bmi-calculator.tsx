...
export default function BmiCalculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-stone-100 dark:bg-gray-900">
      <Card className="bg-purple-300 w-full max-w-md mx-auto">
        <CardHeader>
